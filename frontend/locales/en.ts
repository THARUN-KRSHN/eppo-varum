export const en = {
  ...
  alerts: { title: 'Bus reminders', subtitle: 'This screen demonstrates the reminder flow before live push notifications are connected.', demo: 'Demo only', demoTitle: 'Mannuthy to Ernakulam', demoDescription: 'A sample reminder for the next scheduled bus.', stop: 'Stop', sampleArrival: 'Sample arrival', enable: 'Enable demo reminder', enabled: 'Demo reminder enabled', howTitle: 'How the demo works', howSteps: ['Choose a bus stop on the map and select its timing.', 'Tap the reminder button to save a reminder.', 'This page can trigger a sample response so the flow is testable.'], trigger: 'Trigger next alert', active: 'Active alert', notify: 'Notify 5 minutes before', note: 'This is a timetable-based alert, not live tracking.', noAlerts: 'No alerts yet', noAlertsText: 'Choose a stop and we will help you create a reminder.' },
